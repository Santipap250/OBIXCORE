  ...
  return (
    <div className="max-w-2xl mx-auto px-4 py-6">
      ...
      <PageHeader
        accent="red"
        badge="ConfigDoctor"
        title="วิเคราะห์ปัญหา Build โดรน"
        subtitle="วิเคราะห์ build โดรนแบบละเอียด — Health/Safety/Efficiency/Performance/Reliability Score พร้อม warning และคำแนะนำเรียงลำดับความสำคัญ"
      />
