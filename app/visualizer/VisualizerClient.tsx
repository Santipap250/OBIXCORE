    ...
    <div className="page-shell py-6">
      ...
      <div className="hud-card rounded-[1.75rem] p-5 mb-4 overflow-hidden">
        ...
        <div className="relative flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between">
          <PageHeader
            accent="purple"
            badge="Build Visualizer"
            title="พรีวิวโดรนก่อนประกอบจริง"
            subtitle="ตรวจสอบ compatibility และ preview โดรน FPV ของคุณแบบ interactive"
            className=""
          />
                ...
                <div className="grid grid-cols-4 gap-1.5">
                  {(["2inch", "3inch", "5inch", "7inch"] as FrameSize[]).map(fs => (
                    <button
                      ...
                      aria-pressed={spec.frameSize === fs}
                ...
                <div className="grid grid-cols-3 gap-1.5">
                  {([2, 3, 4] as const).map(b => (
                    <button
                      ...
                      aria-pressed={spec.propBlades === b}
